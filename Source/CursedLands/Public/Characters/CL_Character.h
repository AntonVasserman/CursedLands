...
UCLASS()
class CURSEDLANDS_API ACL_Character : public ACharacter, public IAbilitySystemInterface, public IGameplayTagAssetInterface
{
	GENERATED_BODY()
...
public:
	ACL_Character(const FObjectInitializer& ObjectInitializer);
