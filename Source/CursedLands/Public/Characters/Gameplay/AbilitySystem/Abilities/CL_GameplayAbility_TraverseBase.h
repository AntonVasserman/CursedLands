...
#include "CL_GameplayAbility_TraverseBase.generated.h"

UCLASS(Abstract)
class CURSEDLANDS_API UCL_GameplayAbility_TraverseBase : public UCL_GameplayAbility_PlayerCharacterBase
{
	GENERATED_BODY()
