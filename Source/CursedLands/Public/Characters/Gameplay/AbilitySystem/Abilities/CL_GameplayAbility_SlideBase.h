...
#include "CL_GameplayAbility_SlideBase.generated.h"

UCLASS(Abstract)
class CURSEDLANDS_API UCL_GameplayAbility_SlideBase : public UCL_GameplayAbility_PlayerCharacterBase
{
	GENERATED_BODY()

public:
	UCL_GameplayAbility_SlideBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) { }
