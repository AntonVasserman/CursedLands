...
void UCL_AttributeProgressBar::NativeConstruct()
{
...
const UCL_AttributeSet* UCL_AttributeProgressBar::GetAttributeSetByGameplayTag(const UCL_AbilitySystemComponent* PlayerCharacterAbilitySystemComponent, const FGameplayTag& GameplayTag)
{
